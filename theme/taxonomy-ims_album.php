	 ...
	 get_header(); ?>
		...
		<div id="primary">
			<div id="content" role="main">
				...
				<nav role="navigation">
					<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older Galleries', 'image-store' ) ); ?></div>
					<div class="nav-next"><?php previous_posts_link( __( 'Newer Galleries <span class="meta-nav">&rarr;</span>', 'image-store' ) ); ?></div>
				</nav><!-- #nav-above -->
