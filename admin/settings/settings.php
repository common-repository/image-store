<?php
	...
	$settings_tabs = apply_filters( 'ims_settings_tabs', array(
		'general' 	=> __( 'General', 'image-store'),
		'taxonomies' 	=> __( 'Groups', 'image-store'),
		'gallery' 	=> __( 'Gallery', 'image-store'),
		'image' 	=> __( 'Image', 'image-store'),
		'slideshow' => __( 'Slideshow', 'image-store'),
		'payment' 	=> __( 'Payment', 'image-store'),
		'checkout' 	=> __( 'Checkout', 'image-store'),
		'permissions' => __( 'Permissions', 'image-store'),
		'reset' 	=> __( 'Reset', 'image-store'),
	));
        		...
        		<?php do_action( 'ims_settings', $boxid) ?>
             	<tr>
                    ...
                    <td class="submit">
                      ...
                      <input type="submit" class="button-primary" value="<?php esc_attr_e( 'Save', 'image-store')?>" />
                    </td>
             	</tr>
            </tbody>
          </table>
