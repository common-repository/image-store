<?php
	...
	$output .= '
		<table class="ims-table" role="grid">
			<thead>
				<tr>
					<th scope="col" colspan="3" class="ims-size">' . __('Image size', 'image-store') . '</th>
					<th class="ims-price">' . __('Price', 'image-store') . '</th>
					<th class="ims-blank">&nbsp;</th>
					<th class="ims-download">' . __('Download', 'image-store') . '</th>
					<th class="ims-blank">&nbsp;</th>
				</tr>
			</thead>';
	...
	foreach ( $this->sizes as $size ) :
		...
		//downloadable
		$download = ( isset($size['download']) ) ? __('Included', 'image-store') : '';
	...
	$output .= '<td role="gridcell" colspan="' . ( $colspan ? 3 : 7 ) .'" class="subhead ims-shipping-name">'. ( ( $shipping_count ) ?__( 'Shipping', 'image-store') : '&nbsp;' ) .'</td>';
	if( $color_count ) $output .=	 '<td role="gridcell" colspan="' . ( 6 - $colspan ) .'" class="subhead ims-color-name">'. __( 'Color Options', 'image-store') . '</td>';
	if( $finish_count ) $output .= '<td role="gridcell" colspan="' . ( 6 - $colspan ) .'" class="subhead ims-finish-name">'. __( 'Finishes', 'image-store')  . '</td>';
	$output .= '</tr>';
