<?php
	...
	if ( empty( $this->cart['images'] ) && apply_filters( 'ims_empty_car', true, $this->cart ) ) :
		...
		$error = new WP_Error( );
		$error->add( 'empty', __( 'Your shopping cart is empty.', 'image-store' ) );
		...
		<div class="ims-table" role="grid">
			<div class="ims-subrows ims-header">
				<span class="ims-preview">' . esc_html__( 'Image', 'image-store' ) . '</span>
				<div class="ims-clear-row">
					<span class="ims-quantity">' . esc_html__( 'Quantity', 'image-store' ) . '</span>
					<span class="ims-size">' . esc_html__( 'Size', 'image-store' ) . '</span>
					<span class="ims-color">' . esc_html__( 'Color', 'image-store' ) . '</span>
					<span class="ims-fisnish">' . esc_html__( 'Finish', 'image-store' ) . '</span>
					<span class="ims-price">' . esc_html__( 'Unit Price', 'image-store' ) . '</span>
					<span class="ims-subtotal">' .esc_html__( 'Subtotal', 'image-store' ) . '</span>
					<span class="ims-delete">' . esc_html__( 'Delete', 'image-store' ) . '</span>
				</div>
			</div><!--.ims-header-->';
		...
		$output .= '<div role="row" class="ims-subrows subtotal-row">
			...
			<span role="gridcell" class="ims-th"><label>' . __( 'Item subtotal', 'image-store' ) . '</label></span>
		...
		$output .= '<div role="row" class="ims-subrows promo-row">
			<span role="gridcell" class="ims-empty">&nbsp;</span>
			<span role="gridcell" class="ims-th"><label for="ims-promo-code">' . __( 'Promotional code', 'image-store' ) . '</label></span>
			...
			<span class="ims-break"></span> <small>' . __( 'Update cart to apply promotional code.', 'image-store' ) . '</small></span>
		</div>';
		...
		if ( $this->cart['promo']['discount'] )
			...
			<span role="gridcell" class="ims-empty">&nbsp;</span>
			<span role="gridcell" class="ims-th">' . __( 'Discount', 'image-store' ) . '</span>
		...
		if( $this->cart['shippingcost'] )
			...
			<span role="gridcell" class="ims-empty">&nbsp;</span>
			<span role="gridcell" class="ims-th"><label for="shipping">' . __( 'Shipping', 'image-store' ) . '</label></span>
		...
		if ( $this->cart['tax'] ) 
			...
			<span role="gridcell" class="ims-empty">&nbsp;</span>
			<span role="gridcell" class="ims-th">' . __( 'Tax', 'image-store' ) . '</span>
		...
		<span role="gridcell" class="ims-empty">&nbsp;</span> 
		<span role="gridcell" class="ims-th"><label>' . __( 'Total', 'image-store' ) . '</label></span>
		<span role="gridcell" class="total">' . $this->format_price( $this->cart['total'] ) . ' </span></div>';
		
		//display notification
		$output .= '<div role="row" class="ims-subrows">
		<span role="gridcell" class="ims-empty">&nbsp;</span><span role="gridcell"><label>' . __( 'Additional Instructions', 'image-store' ) . '<br />
		...
		$output .= '<input name="ims-apply-changes" type="submit" value="' . esc_attr__( 'Update Cart', 'image-store' ) . '" class="secondary" />';
		
		$output .= '<span class="ims-bk"></span>';
		$output .= '<span class="ims-cart-actions"><span class="ims-checkout-label">' . __( 'Checkout using:', 'image-store' ) . ' </span>';
